    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow-lg max-w-5xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-semibold text-slate-800">Audit Log</h2>
                <button 
                    onClick={fetchLogs} 
                    disabled={loading}
                    className="px-4 py-2 text-sm rounded-lg bg-slate-100 text-slate-700 font-semibold hover:bg-slate-200 disabled:bg-slate-50 disabled:text-slate-400 disabled:cursor-not-allowed"
                >
